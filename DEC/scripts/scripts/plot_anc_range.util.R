...
add_island_times = function(p, x_offset) {
    t = "dashed"
    p = p + geom_vline(xintercept=x_offset-35.0, color="#7570b3", linetype=t)
    p = p + geom_vline(xintercept=x_offset-15.0, color="#e7298a", linetype=t)
    p = p + geom_vline(xintercept=x_offset-10.0, color="#66a61e", linetype=t)
    p = p + geom_vline(xintercept=x_offset-3.5, color="#e6ab02", linetype=t)
    return(p)
}
